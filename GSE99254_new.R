...
write.table(pbmc.markers_detoxicity,file = "c:/Users/xjmik/Desktop/GSE99254marker_Detoxicity.txt",sep = "\t")
...
write.table(pbmc.markers_detoxicity_big,file = "c:/Users/xjmik/Desktop/GSE99254marker_Detoxicity_tissue.txt",sep = "\t")
Idents(pbmc)<-pbmc$majorCluster
...
library(ggplot2)
ggsave(g1,filename = "c:/Users/xjmik/Desktop/Detoxicity_2/GSE99254_celltype.pdf",width = 20,height = 20)
Idents(pbmc)<-pbmc$Bulksample
...
library(ggplot2)
ggsave(g2,filename = "c:/Users/xjmik/Desktop/Detoxicity_2/GSE99254_tissue.pdf",width = 10,height = 15)
Idents(pbmc)<-pbmc$majorCluster
